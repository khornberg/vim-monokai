...
if &t_Co > 255
   ...
   " more correct monokai
   " try to highlight python class and func params"
   " hi pythonVars      ctermfg=81
   " hi pythonParam      ctermfg=81
   " hi pythonParamName      ctermfg=81
   " hi pythonClassVars      ctermfg=81
   " hi pythonClassParameters      ctermfg=81

    hi pythonClassName ctermfg=148 ctermbg=NONE cterm=NONE guifg=#a6e22e guibg=NONE gui=NONE
    hi pythonParamName ctermfg=208 ctermbg=NONE cterm=NONE guifg=#fd971f guibg=NONE gui=italic
    hi pythonFuncName ctermfg=148 ctermbg=NONE cterm=NONE guifg=#a6e22e guibg=NONE gui=NONE
    hi pythonSuperClass ctermfg=148 ctermbg=NONE cterm=NONE guifg=#a6e22e guibg=NONE gui=italic
    hi pythonDecorator ctermfg=148 ctermbg=NONE cterm=NONE guifg=#a6e22e guibg=NONE gui=NONE
    hi pythonClassDef ctermfg=81 ctermbg=NONE cterm=NONE guifg=#66d9ef guibg=NONE gui=italic
    hi pythonFuncDef ctermfg=81 ctermbg=NONE cterm=NONE guifg=#66d9ef guibg=NONE gui=italic
    hi pythonBuiltInFunc ctermfg=81 ctermbg=NONE cterm=NONE guifg=#66d9ef guibg=NONE gui=italic
    hi pythonBuiltin ctermfg=81 ctermbg=NONE cterm=NONE guifg=#66d9ef guibg=NONE gui=italic
    hi pythonKwargs ctermfg=208 ctermbg=NONE cterm=NONE guifg=#fd971f guibg=NONE gui=italic

    " Javascript
    hi javascriptFuncArg ctermfg=208 ctermbg=NONE cterm=NONE guifg=#fd971f guibg=NONE gui=italic
    hi javascriptVariable ctermfg=81 ctermbg=NONE cterm=NONE guifg=#66d9ef guibg=NONE gui=italic
    hi javascriptFuncKeyword ctermfg=81 ctermbg=NONE cterm=NONE guifg=#66d9ef guibg=NONE gui=italic
    hi javascriptMethod ctermfg=118 ctermbg=NONE cterm=NONE
    hi javascriptBlock ctermfg=118 ctermbg=NONE cterm=NONE
    hi javascriptOperator ctermfg=161 cterm=NONE cterm=NONE
